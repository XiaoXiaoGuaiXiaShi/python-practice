...
def ins_mysql(title, url_n, datea, content, summary, pic_url):
    ...
    # SQL两种插入格式
    sql = """
          INSERT INTO baidu_news(news_title, news_url, news_date,news_summary, news_content,pic_url)
          values('%s','%s','%s','%s','%s','%s');
          """
    par = (title, url_n, datea, content, summary, pic_url)
